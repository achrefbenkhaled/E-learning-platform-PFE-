...
export const Login = () => {
  ...
  const handleGoogleSuccess = async (tokenResponse) => {
    try {
      ...
      // but for backend verification we usually want an ID token.
      // However, we can use the access token to get user info if needed,
      // or configure useGoogleLogin to return an auth code for backend exchange.
      // For simplicity and matching previous implementation, I'll assume we continue with tokens.
      // But actually, standard GoogleLogin provides credential (ID token).
      // useGoogleLogin provides access_token.
      // I will adjust authStore to handle this if needed, but let's stick to a beautiful UI first.
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <p className="text-center text-txt-muted mt-6">
            ...
            <Link to="/register" className="text-indigo-600 hover:text-indigo-500 font-semibold">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
